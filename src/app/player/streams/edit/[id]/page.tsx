...
const EditStream = () => {
  ...
  const handleSubmit = () => {
    ...
    if (validateForm()) {
      ...
      axios
          .put(process.env.NEXT_PUBLIC_API_URL + "/streams/" + id, newData)
          .then(response => {
              var data = response.data;
              var status = data.status;
              if (status == 1) {

                toast.update(id_toast, {render: "Stream updated", type: "success", isLoading: false, autoClose: Number(process.env.NEXT_PUBLIC_TIMEOUT_TOAST)});
  ...
  <LayoutPlayer>
    ...
    <div id="edit-stream" className="flex flex-col flex-1">
        ...
        <div className="bg-vc-border-gradient rounded-lg p-px">
            <div className="py-6 rounded-lg">
              ...
              >
                  ...
                  <div id="form-edit-stream" className="flex flex-col justify-between space-y-2 rounded-lg bg-black p-3.5 lg:px-5 lg:py-3 ">
...
export default useAuth(EditStream);